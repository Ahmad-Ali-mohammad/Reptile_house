...
const sidebarConfig = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "إضافة منتج", page: 'newProduct' as DashboardPage, icon: <PlusIcon className="w-5 h-5" /> },
...
const Sidebar: React.FC<SidebarProps> = ({ activePage, setActivePage, setAppMode }) => {
